...
public class BlitTextureRenderFeature : ScriptableRendererFeature
{
    public Material m_Material;
    private CustomBlitTexturePass m_BlitRenderPass;

    public override void Create()
    {
        m_BlitRenderPass = new CustomBlitTexturePass(m_Material);
        m_BlitRenderPass.renderPassEvent = RenderPassEvent.AfterRenderingPostProcessing;
    }
    ...
    public class CustomBlitTexturePass : ScriptableRenderPass
    {
        Material m_Material;
        const string m_PassName = "BlitTexturePass";

        public CustomBlitTexturePass(Material mat)
        {
            m_Material = mat;
